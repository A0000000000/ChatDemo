...
public class StatusListenServiceConnection
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Message.StatusListenServiceConnection, Message", StatusListenServiceConnection.class, __md_methods);
	}


	public StatusListenServiceConnection ()
	{
		super ();
		if (getClass () == StatusListenServiceConnection.class)
			mono.android.TypeManager.Activate ("Message.StatusListenServiceConnection, Message", "", this, new java.lang.Object[] {  });
	}

	public StatusListenServiceConnection (md5eafba607c12cc72e5d5d2eba63a08e92.MainPage p0)
	{
		super ();
		if (getClass () == StatusListenServiceConnection.class)
			mono.android.TypeManager.Activate ("Message.StatusListenServiceConnection, Message", "Message.MainPage, Message", this, new java.lang.Object[] { p0 });
	}
